...
var _OptionsList = __webpack_require__(15);
...
var SuperSelect = function (_React$Component) {
    _inherits(SuperSelect, _React$Component);

    function SuperSelect(props) {
        _classCallCheck(this, SuperSelect);

        var _this = _possibleConstructorReturn(this, (SuperSelect.__proto__ || Object.getPrototypeOf(SuperSelect)).call(this, props));
        ...
        _this.addSuperSelectToEvent = _this.addSuperSelectToEvent.bind(_this);
        _this.closeOnClickOutside = _this.closeOnClickOutside.bind(_this);
        _this.getAllOptions = _this.getAllOptions.bind(_this);
        _this.getOptions = _this.getOptions.bind(_this);
        _this.getValue = _this.getValue.bind(_this);
        _this.buildbutton = _this.buildbutton.bind(_this);
        _this.toggle = _this.toggle.bind(_this);
        _this.isChecked = _this.isChecked.bind(_this);
        _this.handleChange = _this.handleChange.bind(_this);
        _this.dispatchChanges = _this.dispatchChanges.bind(_this);
        _this.clean = _this.clean.bind(_this);
        _this.selectAll = _this.selectAll.bind(_this);
        _this.handleChangeQ = _this.handleChangeQ.bind(_this);
        _this.handleNavigationKeys = _this.handleNavigationKeys.bind(_this);
        _this.buildOptions = _this.buildOptions.bind(_this);
        _this.buildSearchBox = _this.buildSearchBox.bind(_this);
        _this.buildActions = _this.buildActions.bind(_this);
    ...
    _createClass(SuperSelect, [{
        ...
        key: "addSuperSelectToEvent",
        value: function addSuperSelectToEvent(e) {
        ...
        value: function getOptions() {
            ...
            var q = this.state.q;
            var fuse = new _fuse2.default(options, {
        ...
        key: "isChecked",
        value: function isChecked(item, returnIndex) {
        ...
        key: "dispatchChanges",
        value: function dispatchChanges(newValue) {
            if (this.props.valueLink) {
        ...
        key: "handleNavigationKeys",
        value: function handleNavigationKeys(e) {
            "use strict";
...
SuperSelect.propTypes = {
    ...
    clearAllLabel: _propTypes2.default.string,
    content: _propTypes2.default.node,
    contentLabelProvider: _propTypes2.default.func,
    groups: _propTypes2.default.array,
    label: _propTypes2.default.string.isRequired,
    labelKey: _propTypes2.default.string,
    maxLabels: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.bool]),
    moreSelectedLabel: _propTypes2.default.string,
    ...
    searchBox: _propTypes2.default.bool,
                ...
                if (this.props.multiple && this.props.value.length) {
                    ...
                    if (this.props.value.length === this.props.allOptions.length) {
                        ...
                        this.props.value.map(function (item, index) {
                            if (_this2.props.maxLabels === false || countValues < _this2.props.maxLabels) {
                                text.push(_react2.default.createElement(
                                    "span",
                                    { className: "super-select-button-label-value", key: index },
                                    item[_this2.props.labelKey]
                                ));
                                countValues++;
                            }
                        });
                        ...
                        if (this.props.maxLabels !== false && this.props.maxLabels < this.props.value.length) {
                            text.push(_react2.default.createElement(
                                ...
                                this.props.moreSelectedLabel ? this.props.moreSelectedLabel : "mais ".concat((this.props.value.length - this.props.maxLabels).toString())
                            ));
                        }
                    }
    ...
    _createClass(OptionsList, [{
        ...
        value: function renderOptions() {
            ...
            return options.map(function (item, index) {
                var optionProps = {
                    index: index,
                    pseudoHover: index === _this2.props.currentHover,
                    checked: _this2.props.isChecked(item),
                    option: item,
                ...
                if (_this2.props.optionRender) {
                    return _this2.props.optionRender(optionProps);
                }

                return _react2.default.createElement(_Option2.default, _extends({}, optionProps, { key: index }));
            });
        }
    }, {
        key: "render",
...
SearchBox.propTypes = {
    ...
    searchArgument: _propTypes2.default.string,
    searchArgumentChange: _propTypes2.default.func
};
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.props.actions.map(function (action, index) {
                    return _react2.default.createElement(_Action2.default, _extends({}, action, { key: index }));
                })
            );
        }
    }]);
